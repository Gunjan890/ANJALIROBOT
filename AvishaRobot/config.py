...
class Config(object):
    ...
    JOIN_LOGGER = getenv("JOIN_LOGGER", "-1002467794421")
   
    EVENT_LOGS = getenv("EVENT_LOGS",  "-1002467794421")
  
    ERROR_LOGS = getenv("ERROR_LOGS", "-1001970031336")

    MONGO_DB_URI= getenv("MONGO_DB_URI", None)
   
    LOG_CHANNEL = getenv("LOG_CHANNEL", "-1002467794421")
