...
def totranslate(update: Update, context: CallbackContext) -> None:
    ...
    reply = (
        ...
        f"♥︎ {translation.text}\n\n❖ ᴘᴏᴡᴇʀᴇᴅ ʙʏ ➥ 🫧⏤͟͟͞ـﮩ♡︎ ˹Ҩ፝֟፝ɴ ꫝɴᴊᴀʟɪ˼ [🇮🇳]"
    )
...
AVISHA = "https://te.legra.ph/file/120248292430d07703a6e.jpg"
...
async def gib_repo_callback(_, callback_query):
    await callback_query.edit_message_media(
        media=InputMediaVideo("https://te.legra.ph/file/0c56841859f735bb4d6f0.mp4", has_spoiler=True),
        reply_markup=InlineKeyboardMarkup(
            [
                [close_button]
            ]
